...
- ✓ KEPT **4-layer time MLP (sinusoidal→256→256→256→256)** (0.031385→0.029530, −0.001855): another ~65k params, consistent improvement — deeper time MLPs keep helping. Current best: 0.029530.
  - Follow-on: 5-layer time MLP (sinusoidal→256→256→256→256→256) — diminishing returns likely but still cheap to try
